                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('ads.index') }}">{{__('messages.ads.name')}}</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('ads.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>{{__('messages.ads.title')}} - <img src="{{ asset('uz.png') }}" alt="uz"
                                                                            width="18"></label>
                            ...
                            <div class="form-group">
                                <label>{{__('messages.ads.title')}} - <img src="{{ asset('ru.png') }}" alt="uz"
                                                                            width="18"></label>
                            ...
                            <div class="form-group">
                                <label>{{__('messages.ads.title')}} - <img src="{{ asset('en.png') }}" alt="uz"
                                                                            width="18"></label>
                            ...
                            <div class="form-group">
                                <label for="description_uz">{{ __('messages.ads.description') }}  - <img src="{{ asset('uz.png') }}" alt="uz"
                                                                            width="18"></label>
                             ...
                             <div class="form-group">
                                <label for="description_en">{{ __('messages.ads.description') }}  - <img src="{{ asset('en.png') }}" alt="uz"
                                                                            width="18"></label>
                             ...
                             <div class="form-group">
                                <label for="description_ru">{{ __('messages.ads.description') }}  - <img src="{{ asset('ru.png') }}" alt="uz"
                                                                            width="18"></label>
