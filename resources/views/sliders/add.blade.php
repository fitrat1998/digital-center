                        ...
                        <form action="{{ route('sliders.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="caption_uz" id="caption_uz"
                                          class="form-control editor {{ $errors->has('caption_uz') ? 'is-invalid' : '' }}">{{ old('caption_uz') }}</textarea>
                                @error('caption_uz')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="caption_en" id="caption_en"
                                          class="form-control editor {{ $errors->has('caption_en') ? 'is-invalid' : '' }}">{{ old('caption_en') }}</textarea>
                                @error('caption_en')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="caption_ru" id="caption_ru"
                                          class="form-control editor {{ $errors->has('caption_ru') ? 'is-invalid' : '' }}">{{ old('caption_ru') }}</textarea>
                                @error('caption_ru')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
