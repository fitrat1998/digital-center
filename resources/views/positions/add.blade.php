                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('positions.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>{{__('messages.positions.title')}} - <img src="{{ asset('uz.png') }}" alt="uz"
                                                                                 width="18"></label>
                            ...
                            <div class="form-group">
                                <label>{{__('messages.positions.title')}} - <img src="{{ asset('ru.png') }}" alt="uz"
                                                                                 width="18"></label>
                            ...
                            <div class="form-group">
                                <label>{{__('messages.positions.title')}} - <img src="{{ asset('en.png') }}" alt="uz"
                                                                                 width="18"></label>
